...
- 🐛 Restore brand colours and cropping on the ErrorPage default symbol [\#28](https://github.com/Enabel/ux/pull/28) ([damienlagae](https://github.com/damienlagae))
- ⬆️ Upgrade PHPUnit to 12 & test Symfony 7.4/8.1 in CI [\#27](https://github.com/Enabel/ux/pull/27) ([damienlagae](https://github.com/damienlagae))
